...
class _HometopLevelPagestate extends State<HomeScreen> {
  ...
  void initState() {
    ...
    context.read<StudentExtendedBloc>().add(studentProfileGet(widget.studentID));
  }
    ...
    return BlocConsumer<StudentExtendedBloc, StudentExtendedState>(
      ...
      builder: (context, state) {
        return Scaffold(
          ...
          body: isProfileLoaded ? _mainWrapperBody() : Center(child: Lottie.asset(
            ...
            child: Column(
              ...
              children: [
                ...
                Icon(
                  ...
                  color: context.watch<StudentBottomBloc>().state.tabIndex == page
                      ? primary_color
                      : Colors.grey,
                  size: iconSize,
                ),
                ...
                Text(
                  ...
                  style: TextStyle(
                    color: context.watch<StudentBottomBloc>().state.tabIndex == page
                        ...
                        : Colors.grey,
                    fontSize: fontSize,
                    fontWeight: context.watch<StudentBottomBloc>().state.tabIndex == page
                        ? FontWeight.w600
                        : FontWeight.w400,
                  ),
                ),
