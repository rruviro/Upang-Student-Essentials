...
class books_list extends StatelessWidget {
  ...
  books_list({Key? key, required this.status}) : super(key: key);
  @override
          ...
          child: Row(
            ...
            children: [
              Container(
                ...
                child: Image.network(
                    "assets/book.jpg"), // Placeholder for actual image
              ),
              SizedBox(width: 10),
              Stack(
                children: [
                        ...
                        content: SingleChildScrollView(
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                'Subject Description: ${item.subjectDesc}',
                                style: TextStyle(
                                    fontSize: 14,
                                    color: Colors.black87,
                                    fontWeight: FontWeight.w400),
